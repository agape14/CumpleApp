    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <i class="bi bi-person-plus-fill"></i> Agregar Nuevo Familiar
            </div>
            <div class="card-body">
                <form action="{{ route('familiares.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('notas') is-invalid @enderror" 
                                  ...
                                  name="notas" 
                                  rows="3"
                                  placeholder="Información adicional, gustos, preferencias, etc.">{{ old('notas') }}</textarea>
                        @error('notas')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-save-fill"></i> Guardar Familiar
                        </button>
                    </div>
                </form>
            </div>
